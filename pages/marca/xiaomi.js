    ...
    if (selectedAvailability !== 'all') {
      filtered = filtered.filter(product => {
        if (selectedAvailability === 'seminovos') {
          // Para seminóvos, filtramos apenas produtos que são realmente seminóvos da Xiaomi
          // Verifica se o nome contém "seminovo" E se é produto Xiaomi
          const productName = product.name?.toLowerCase() || '';
          const isXiaomiSeminovo = productName.includes('seminovo') || productName.includes('seminóvo');
          return isXiaomiSeminovo;
        } else {
