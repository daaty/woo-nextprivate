...
// Importando o novo componente de botão de navegação
...
export default function SamsungPage() {
  ...
  const [currentPage, setCurrentPage] = useState(1);  const [visibleItems, setVisibleItems] = useState(8); // Número de itens visíveis atualmente
  ...
  useEffect(() => {
    ...
    console.log('🔍 Buscando produtos da Samsung...');
    
    fetch('/api/products?category=samsung&per_page=50')
      .then(async (res) => {
        ...
        if (productsArray.length === 0) {
          console.warn('⚠️ Nenhum produto encontrado para a categoria Samsung');
        } else {
  ...
  return (
    <Layout>
      {/* SEO e Metadados */}
      <Head>
        <title>Smartphones Samsung | Loja Oficial</title>
        <meta name="description" content="Compre smartphones Samsung originais com os melhores preços. Galaxy S, Note, A e mais modelos com entrega rápida e garantia oficial." />
        
        {/* OpenGraph tags para compartilhamento em redes sociais */}
        <meta property="og:title" content="Smartphones Samsung | Loja Oficial" />
        <meta property="og:description" content="Compre smartphones Samsung originais com os melhores preços. Todos os modelos com garantia oficial e entrega rápida." />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="/Custom/Content/Themes/samsung/Imagens/samsung-products.png" />
        <meta property="og:url" content={`${process.env.NEXT_PUBLIC_SITE_URL || 'https://seusite.com'}/marca/samsung`} />
        
        {/* Twitter Card tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Smartphones Samsung | Loja Oficial" />
        <meta name="twitter:description" content="Compre smartphones Samsung originais com os melhores preços." />
        <meta name="twitter:image" content="/Custom/Content/Themes/samsung/Imagens/samsung-products.png" />
      </Head>

      {/* Banner Hero para a marca Samsung */}
      <div style={{
        marginTop: '-50px',
        position: 'relative',
        zIndex: 1
        ...
        <SectionContainer noPadding>
          <div className={`${homeBrandStyles.brandBanner} ${homeBrandStyles.samsung}`} style={{ 
            minHeight: '450px',
            height: '100%',
            display: 'flex',
            ...
            <div style={{
              ...
              <video
                src="/videos/samsung-products-showcase.mp4"
                style={{ 
                  width: '100%',
                  height: '100%',
                  objectFit: "cover",
            ...
            <div style={{
              ...
              <div style={{
                ...
                {/* Logo Samsung removido */}
                {/* <div className={homeBrandStyles.brandLogo} style={{ marginBottom: '10px' }}>
                  <Image
                    src="/Custom/Content/Themes/samsung/Imagens/samsung-logo-white.png"
                    alt="Logo Samsung"
                    width={120}
                    height={80}
                ...
                {/* Navegação de marcas fixa no pé do banner */}
                <div style={{
                  ...
                  padding: isMobile ? '12px 12px 18px' : '20px 0 30px',
                  ...
                  <div
                    ...
                    style={{
                      ...
                      overflowX: isMobile ? 'auto' : 'visible',
                      padding: isMobile ? '6px 0' : '5px 12px',
                      margin: 0,
                      width: '100%',
                      maxWidth: '100vw',
                      boxSizing: 'border-box',
                  ...
                  >
                    ...
                    <BrandNavigationButton brand="Samsung" isActive={true} />
        ...
        <div className={styles.mainContent}>
          ...
          <div className={`${styles.sidebarFilters}`} style={{ 
            ...
            <div style={{
              ...
              borderRadius: '12px',
              padding: '2px',
              background: 'linear-gradient(90deg, #1428a0, #000000)',
              content: '""',
            ...
            <div style={{
              position: 'relative',
              zIndex: 1,
              background: 'linear-gradient(90deg, rgba(20,40,160,0.03), rgba(0,0,0,0.03))',
              borderRadius: '10px',
              padding: '15px',
              ...
              <div style={{ display: isMobile ? 'block' : 'none' }}>
                <FilterToggleButton 
                  ...
                  onToggle={(newState) => {
                    console.log('Alternando filtros Samsung para:', newState);
              ...
              >
                ...
                <div className={styles.filterGroup}>
                  <h3>Cor</h3>
                  <div className={styles.filterOptions}>
                    {['Preto', 'Branco', 'Azul', 'Verde', 'Roxo', 'Dourado', 'Prata'].map(color => (
                        ...
                        <div className={styles.productImage} style={{ 
                          ...
                          {(product.image?.sourceUrl || product.images?.[0]?.src) ? (
                            <Image
                              ...
                              alt={product.name || "Produto Samsung"}
                              width={240}
                              height={240}
                              style={{ objectFit: "contain" }}
                              loading="lazy"
        ...
        <div className={styles.brandFooter}>
          <div className={styles.footerGridContainer}>
            <div className={styles.footerColumn}>
              <h3>Categorias Samsung</h3>
              <ul>
                <li><Link href="/marca/samsung/galaxy-s"><a>Galaxy S Series</a></Link></li>
                <li><Link href="/marca/samsung/galaxy-note"><a>Galaxy Note</a></Link></li>
                <li><Link href="/marca/samsung/galaxy-a"><a>Galaxy A Series</a></Link></li>
                <li><Link href="/marca/samsung/acessorios"><a>Acessórios</a></Link></li>
              </ul>
            </div>
            ...
            <div className={styles.footerColumn}>
              ...
              <ul>
                <li><Link href="/produto/samsung-galaxy-s23"><a>Galaxy S23</a></Link></li>
                <li><Link href="/produto/samsung-galaxy-s23-ultra"><a>Galaxy S23 Ultra</a></Link></li>
                <li><Link href="/produto/samsung-galaxy-z-fold-5"><a>Galaxy Z Fold 5</a></Link></li>
                <li><Link href="/produto/samsung-galaxy-a54"><a>Galaxy A54</a></Link></li>
                <li><Link href="/produto/samsung-galaxy-s21-fe"><a>Galaxy S21 FE</a></Link></li>
              </ul>
            </div>
            ...
            <div className={styles.footerColumn}>
              ...
              <ul>
                <li><Link href="/garantia-samsung"><a>Garantia oficial Samsung</a></Link></li>
                <li><Link href="/assistencia-tecnica"><a>Assistência técnica</a></Link></li>
                <li><Link href="/samsung-care-plus"><a>Samsung Care+</a></Link></li>
            ...
            <div className={styles.footerColumn}>
              ...
              <div className={styles.footerInfo}>
                <p>A Samsung é líder global em tecnologia e inovação, oferecendo smartphones premium com as tecnologias mais avançadas do mercado.</p>
                <div className={styles.footerBrandLogo}>
                  <Image
                    src="/Custom/Content/Themes/samsung/Imagens/samsung-logo-gray.png"
                    alt="Logo Samsung"
                    width={80}
                    height={50}
                    style={{ objectFit: "contain" }}
                ...
                <Link href="/sobre-samsung">
                  <a className={styles.footerLink}>Saiba mais sobre a Samsung</a>
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className={styles.footerCTA}>
            <div className={styles.ctaContent}>
              ...
              <p>Receba ofertas exclusivas e novidades sobre os lançamentos Samsung</p>
      ...
      <BreadcrumbSchema 
        items={[
          ...
          { name: 'Samsung', url: '/marca/samsung' }
        ]}
      />
    </Layout>
  );
